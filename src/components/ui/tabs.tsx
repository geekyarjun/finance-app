...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'data-[state=active]:after:content-[""] data-[state=active]:after:w-full data-[state=active]:after:h-[3px] data-[state=active]:after:bg-primary',
      'data-[state=active]:after:absolute data-[state=active]:after:bottom-0',
      'data-[state=active]:after:rounded-tl-[10px] data-[state=active]:after:rounded-tr-[10px]',
      className,
    )}
    {...props}
  />
...
//data-[state=active]:border-b-[3px] data-[state=active]:border-b-primary
